...
async def cb_handler(client, query):
    ...
    if query.data == "start_data":
        ...
        keyboard = InlineKeyboardMarkup(
            [
              [
                    InlineKeyboardButton("Channel", url="https://t.me/joinchat/ifrtIOdJvScyMDhl"),
                    InlineKeyboardButton("Group", url="https://t.me/Carnival_Cinemas_Group")
                ]
            ]
        )
            ...
            [
                [
                    InlineKeyboardButton(
                        "UPDATES", url="https://t.me/NN_NAZRIYANAZEEM_BETA")
                ],
                [
